  ...
  for await (const product of products) {
    let _product = {
      ...
      productImage: product.productImage
        ? await getImageURL(product.productImage)
        : "",
      productPrice: product?.productPrice,
      discountedPrice: GeneralHelperInstance.getDiscountedPrice(
      ...
      familyImage: product?.family?.familyImage
        ? await getImageURL(product?.family?.familyImage)
        : "",
